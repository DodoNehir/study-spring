package com.example.testboard.exception;

import com.example.testboard.model.error.ClientErrorResponse;
...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ClientErrorResponse> handleClientErrorException(
    ...
    return new ResponseEntity<>(
        new ClientErrorResponse(HttpStatus.BAD_REQUEST, errorMessage),
